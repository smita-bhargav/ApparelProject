...
public class ExcelReader {
	...
	public static Object[][] ReadExcelToObjectArr(String filepath, String filename, String sheetname)
			throws IOException {
		File file = new File(filepath + "/" + filename);

		FileInputStream inputStream = new FileInputStream(file);
		// if i want to read from a xlsx file - i need to create an instance
		// of XSSFWorkbook - if i want to read from xls file - i need to create
		// an
		...
		// number of data sets for the testcases - different sets of data for
		// the testcase
		int rowCount = sheet.getLastRowNum();

		System.out.println("Number of Rows : " + rowCount); // this does not
															// take into
															// consideration the
															// headerow - only
															// data rows
