...
public class ApparelSharProdGmail {
	public ApparelSharProdGmail() {
		PropertyConfigurator.configure("./log4j.properties");
		// TODO Auto-generated constructor stub
	}
	private static final Logger logger =Logger.getLogger("ApparelSharProdGmail");
	...
	public void lgnPinApparel() throws IOException, InterruptedException {
		...
		logger.info("Parent Window ID - " + parentWinID+" : "+shareprodPinObj.getGoogleShareClk().getText());
