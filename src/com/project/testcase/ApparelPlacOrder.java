...
public class ApparelPlacOrder {
	...
	public ApparelPlacOrder() {
		PropertyConfigurator.configure("./log4j.properties");
		// TODO Auto-generated constructor stub
	}
	private static final Logger logger =Logger.getLogger("ApparelPlacOrder");
	...
	public void signIn(Hashtable<String, String> dataxl) throws IOException {
		try {
			PlaceOrdParam signinDetail = new PlaceOrdParam(driver);
		...
		{
			TakingScreenShots.capturescreen(driver, "ApparelOrderError");
			throw (e);
	}
	}
	...
	public void searchApparel() throws IOException, InterruptedException {
		...
		Thread.sleep(3000);
		logger.info("dress : "+placeordObj.getMainMenu().getText());
	...
	public void SignOut() throws IOException{
		PlaceOrdParam placeOrdlogObj = new PlaceOrdParam(driver);
		js.executeScript("window.scrollBy(0,-250)", ""); // scroll up
		WebElement logOf = placeOrdlogObj.getLogoutClickbtn();
